...
import view.*;
import chartjava.chart.blankchart.BlankPlotChart;
import chartjava.chart.blankchart.BlankPlotChatRender;
import chartjava.spline.Spline;
import chartjava.spline.SplinePoint;
...
public class CurveLineChart extends JComponent {
    ...
    public void addLegend(String name, Color color1, Color color2) {
        ...
        legends.add(data);
        final LegendItem legend = new LegendItem(data, legends.size() - 1);
